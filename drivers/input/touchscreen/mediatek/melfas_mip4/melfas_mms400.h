...
//Select Chip Model
#define CONFIG_TOUCHSCREEN_MELFAS_MMS438
...
#define INPUT_REPORT_TYPE 		0	// 0 or 1

//Features
#define MMS_USE_NAP_MODE			0	// 0 or 1
#define MMS_USE_GESTURE_WAKEUP_MODE	1	// 0 or 1
#define MMS_USE_TEST_MODE			1	// 0 or 1 (Optional - Sysfs test functions)
#define MMS_USE_CMD_MODE			0	// 0 or 1 (Optional - Sysfs command functions)
...
void mms_fw_update_controller(struct mms_ts_info *info, const struct firmware *fw,
                              struct i2c_client *client);
extern int mx_tsp_device_create(void);
