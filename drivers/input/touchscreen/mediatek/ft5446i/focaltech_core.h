...
#define TPD_KEYS_DIM            		    {{90,1200,20,TPD_BUTTON_HEIGH}, {270,1200,20,TPD_BUTTON_HEIGH}, {450,1200,20,TPD_BUTTON_HEIGH}}

/*********************Custom Define end*************************************************/
//#define MT_PROTOCOL_B
#define GTP_ESD_PROTECT                    1
#define FTS_COMPATIBLE_MODE                0
#define TPD_NAME    							"FTS"
...
//#define FTS_PALM_SUSPEND
//#define CONFIG_TOUCHPANEL_PROXIMITY_SENSOR
#define FTS_SMART_COVER_SWITCH
...
#ifdef FTS_ERROR
#undef FTS_ERROR
#define FTS_ERROR(fmt, args...) 			printk(KERN_ERR"[FTS-ERROR]" fmt, ## args)
#else
...
#ifdef FTS_INFO
#undef FTS_INFO
#define FTS_INFO(fmt, args...) 			    printk(KERN_INFO"[FTS-INFO]" fmt, ## args)
#else
