...
#define FW_IMAGE_NAME "synaptics_tp_fw_update.image"
...
static unsigned int synaptics_image_fw_id = 0;
static unsigned int synaptics_image_cfg_id = 0;
...
static enum flash_area fwu_go_nogo(void) {
    ...
    SYNA_INFO("fwu go nogo Device firmware ID = %d\n", device_fw_id);
    ...
    synaptics_image_fw_id = (unsigned int)image_fw_id;
    SYNA_INFO("fwu go nogo Image firmware ID = %d\n", (unsigned int)image_fw_id);

    if (image_fw_id > device_fw_id) {
        SYNA_INFO("image_fw_id  > device_fw_id\n");
        //flash_area = UI_FIRMWARE;
        //goto exit;
    ...
    dev_info(&fwu->rmi4_data->i2c_client->dev,
             ...
             config_id[2],
             config_id[3]);
    SYNA_INFO("fwu go nogo Device config ID = %d\n", device_config_id);
    ...
    synaptics_image_cfg_id = image_config_id;
    SYNA_INFO("fwu go nogo Image config ID = %d\n", image_config_id);
...
static int fwu_start_reflash(void) {
    ...
    //here update fw cfg version
    switch (flash_area) {
		case UI_FIRMWARE:
			gtp_fw_version = synaptics_image_fw_id;
		break;
		case CONFIG_AREA:
      gtp_fw_version = synaptics_image_fw_id;
			gtp_cfg_version = synaptics_image_cfg_id;
		break;
    }
    SYNA_INFO("update fw cf version gtp_fw_version %d gtp_cfg_version = %d\n",gtp_fw_version, gtp_cfg_version);
...
static int synaptics_rmi4_fwu_init(struct synaptics_rmi4_data *rmi4_data) {
    ...
    gtp_cfg_version = device_config_id;
    SYNA_INFO("synaptics rmi4 fwu init device_config_id = %d \n", device_config_id);
