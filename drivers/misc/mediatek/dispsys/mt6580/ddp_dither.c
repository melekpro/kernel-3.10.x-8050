...
/* [bugfix]-Mod-BEGIN by TCTSZ.yaohui.zeng, 2015/08/17, PR1047378,PR1058133, disable dither,fix screen flash issue*/
    DISP_REG_MASK(cmdq, DISP_REG_DITHER_EN, 0, 0x1);
    DISP_REG_MASK(cmdq, DISP_REG_DITHER_CFG, 0 << 1, 1 << 1);
/* [bugfix]-Mod-END by TCTSZ.yaohui.zeng, 2015/08/17 */
