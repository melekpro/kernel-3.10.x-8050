...
static int RG_Ratio_Typical = 573;   // 315
static int BG_Ratio_Typical = 586;	//291
...
//chengming.xiang modify 2015-12-08 : OTP Should be opened 
#ifdef OV5670_OTP
				if (get_moduleID() == OV5670_MODULE_ID){
