...
void GC0310MIPI_Sensor_Init(void)
{
  ...
  /////////////////////////////////////////////////
	...
	GC0310MIPI_write_cmos_sensor(0xa1,0x33);
 	GC0310MIPI_write_cmos_sensor(0xa2,0x32);
	GC0310MIPI_write_cmos_sensor(0xa4,0x50);
	GC0310MIPI_write_cmos_sensor(0xa5,0x20);
	GC0310MIPI_write_cmos_sensor(0xaa,0x38); 
	GC0310MIPI_write_cmos_sensor(0xac,0x66);
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0xd1,0x28); //32
	GC0310MIPI_write_cmos_sensor(0xd2,0x28); //32
	...
	GC0310MIPI_write_cmos_sensor(0x1f,0x15); 
	GC0310MIPI_write_cmos_sensor(0x20,0xb0); 
	...
	GC0310MIPI_write_cmos_sensor(0xa9,0xbf);
	GC0310MIPI_write_cmos_sensor(0xaa,0x8c);
	...
	GC0310MIPI_write_cmos_sensor(0xd0,0x34);
	GC0310MIPI_write_cmos_sensor(0xd1,0x04);
	GC0310MIPI_write_cmos_sensor(0xd2,0x06);
...
*/
	...
	GC0310MIPI_write_cmos_sensor(0x17,0xe3);
	...
	GC0310MIPI_write_cmos_sensor(0x2a,0xba); 
...
BOOL GC0310MIPI_set_param_banding(UINT16 para)
{
	switch (para)
	{
		...
		case AE_FLICKER_MODE_60HZ:
			...
			GC0310MIPI_write_cmos_sensor(0x28, 0xA0); 
			GC0310MIPI_write_cmos_sensor(0x29, 0x03);   //exp level 1  13fps
			GC0310MIPI_write_cmos_sensor(0x2a, 0xC0); 
			GC0310MIPI_write_cmos_sensor(0x2b, 0x06);   //exp level 2  7.5fps
			GC0310MIPI_write_cmos_sensor(0x2c, 0x60); 
