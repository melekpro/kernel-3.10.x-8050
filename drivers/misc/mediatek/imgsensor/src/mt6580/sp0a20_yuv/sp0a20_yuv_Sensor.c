//V1.1.0 Kavie 20150804 MTK8321 SP0A20MIPI PIXI3-10-3G
...
{	 
	...
	temp_AWB_reg = SP0A20_read_cmos_sensor(0x32);
	
	if (enalbe)
	{
		SP0A20_write_cmos_sensor(0x32, (temp_AWB_reg |0x10));
	}
	else
	{
		SP0A20_write_cmos_sensor(0x32, (temp_AWB_reg & (~0x10)));
	...
	if (!SP0A20_Sensor_Driver.MODE_CAPTURE) { 
		...
		{ 
			...
			else 
			{
				...
				if(isBanding== 0)
				{
					...
					SP0A20_write_cmos_sensor(0x09,0x00);
					SP0A20_write_cmos_sensor(0xfd,0x02);
					SP0A20_write_cmos_sensor(0xbe,0xb0);
					SP0A20_write_cmos_sensor(0xbf,0x04);
					SP0A20_write_cmos_sensor(0xd0,0xb0);
				...
				{
					//capture preview night 24M 60hz 6-15FPS maxgain:78
					SP0A20_write_cmos_sensor(0xfd,0x00);
					SP0A20_write_cmos_sensor(0x03,0x01);
					...
					SP0A20_write_cmos_sensor(0x09,0x00);
					SP0A20_write_cmos_sensor(0xfd,0x02);
					SP0A20_write_cmos_sensor(0xbe,0xec);
					SP0A20_write_cmos_sensor(0xbf,0x04);
					SP0A20_write_cmos_sensor(0xd0,0xec);
					SP0A20_write_cmos_sensor(0xd1,0x04);
					SP0A20_write_cmos_sensor(0xfd,0x00);
		...
		else    // daylight mode
		{
			...
			else 
			{
				if(isBanding== 0)
				{	
					//capture preview daylight 24M 50hz 16-8FPS maxgain:  70
					SP0A20_write_cmos_sensor(0xfd,0x00);
					SP0A20_write_cmos_sensor(0x03,0x01);
					SP0A20_write_cmos_sensor(0x04,0xe0);
					SP0A20_write_cmos_sensor(0x05,0x00);
					SP0A20_write_cmos_sensor(0x06,0x00);
					SP0A20_write_cmos_sensor(0x07,0x00);
					SP0A20_write_cmos_sensor(0x08,0x00);
					SP0A20_write_cmos_sensor(0x09,0x02);
					SP0A20_write_cmos_sensor(0x0a,0x90);
					SP0A20_write_cmos_sensor(0xfd,0x01);
					SP0A20_write_cmos_sensor(0xf0,0x00);
					SP0A20_write_cmos_sensor(0xf7,0x50);
					SP0A20_write_cmos_sensor(0x02,0x0c);
					SP0A20_write_cmos_sensor(0x03,0x01);
					SP0A20_write_cmos_sensor(0x06,0x50);
					SP0A20_write_cmos_sensor(0x07,0x00);
					SP0A20_write_cmos_sensor(0x08,0x01);
					SP0A20_write_cmos_sensor(0x09,0x00);
					SP0A20_write_cmos_sensor(0xfd,0x02);
				...
				{
					//capture preview daylight 24M 60hz 8-16FPS maxgain:70
					SP0A20_write_cmos_sensor(0xfd,0x00);
					SP0A20_write_cmos_sensor(0x03,0x01);
					SP0A20_write_cmos_sensor(0x04,0x92);
					SP0A20_write_cmos_sensor(0x05,0x00);
					SP0A20_write_cmos_sensor(0x06,0x00);
					SP0A20_write_cmos_sensor(0x07,0x00);
					SP0A20_write_cmos_sensor(0x08,0x00);
					SP0A20_write_cmos_sensor(0x09,0x02);
					SP0A20_write_cmos_sensor(0x0a,0x89);
					SP0A20_write_cmos_sensor(0xfd,0x01);
					SP0A20_write_cmos_sensor(0xf0,0x00);
					SP0A20_write_cmos_sensor(0xf7,0x43);
					SP0A20_write_cmos_sensor(0x02,0x0f);
					SP0A20_write_cmos_sensor(0x03,0x01);
					SP0A20_write_cmos_sensor(0x06,0x43);
					SP0A20_write_cmos_sensor(0x07,0x00);
					SP0A20_write_cmos_sensor(0x08,0x01);
					SP0A20_write_cmos_sensor(0x09,0x00);
					SP0A20_write_cmos_sensor(0xfd,0x02);
					SP0A20_write_cmos_sensor(0xbe,0xed);
					SP0A20_write_cmos_sensor(0xbf,0x03);
					SP0A20_write_cmos_sensor(0xd0,0xed);
					SP0A20_write_cmos_sensor(0xd1,0x03);
					SP0A20_write_cmos_sensor(0xfd,0x00);
 ...
 
{
	...
	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0x04,0xb0);
	...
	SP0A20_write_cmos_sensor(0x10,0x1a);//0x00
	SP0A20_write_cmos_sensor(0x11,0x1a);//0x00
	SP0A20_write_cmos_sensor(0xfd,0x00);
	...
	SP0A20_write_cmos_sensor(0x66,0x48);
	SP0A20_write_cmos_sensor(0x67,0x68);
	SP0A20_write_cmos_sensor(0x68,0xcd);
	SP0A20_write_cmos_sensor(0x69,0xef);
	...
	SP0A20_write_cmos_sensor(0xd7,0x09);
	SP0A20_write_cmos_sensor(0xd8,0x0d);
	SP0A20_write_cmos_sensor(0xd9,0x14);
	SP0A20_write_cmos_sensor(0xda,0x18);
	SP0A20_write_cmos_sensor(0xe8,0x20);
	SP0A20_write_cmos_sensor(0xe9,0x1c);
	SP0A20_write_cmos_sensor(0xea,0x18);
	SP0A20_write_cmos_sensor(0xeb,0x16);
	SP0A20_write_cmos_sensor(0xec,0x24);
	SP0A20_write_cmos_sensor(0xed,0x20);
	SP0A20_write_cmos_sensor(0xee,0x1c);
	SP0A20_write_cmos_sensor(0xef,0x18);
	...
	SP0A20_write_cmos_sensor(0x6d,0x0d);
	SP0A20_write_cmos_sensor(0x6e,0x14);
	SP0A20_write_cmos_sensor(0x6f,0x1c);
	SP0A20_write_cmos_sensor(0x70,0x20);
	SP0A20_write_cmos_sensor(0x86,0x18);
	SP0A20_write_cmos_sensor(0x71,0x10);
	SP0A20_write_cmos_sensor(0x72,0x14);
	SP0A20_write_cmos_sensor(0x73,0x1c);
	SP0A20_write_cmos_sensor(0x74,0x20);

	SP0A20_write_cmos_sensor(0x75,0x09);
	SP0A20_write_cmos_sensor(0x76,0x10);
	SP0A20_write_cmos_sensor(0x77,0x16);
	SP0A20_write_cmos_sensor(0x78,0x18);
	SP0A20_write_cmos_sensor(0x79,0x34);
	SP0A20_write_cmos_sensor(0x7a,0x23);
	SP0A20_write_cmos_sensor(0x7b,0x11);
	...
	SP0A20_write_cmos_sensor(0x8c,0x0c);
	...
	SP0A20_write_cmos_sensor(0x9b,0xe0);
	SP0A20_write_cmos_sensor(0x9c,0xe8);
	SP0A20_write_cmos_sensor(0x9d,0xee);
	SP0A20_write_cmos_sensor(0x9e,0xf4);
	SP0A20_write_cmos_sensor(0x9f,0xf8);
	SP0A20_write_cmos_sensor(0xa0,0xfa);

	SP0A20_write_cmos_sensor(0xfd,0x02);
	SP0A20_write_cmos_sensor(0x15,0xc4);
	SP0A20_write_cmos_sensor(0x16,0x8c);

	SP0A20_write_cmos_sensor(0xa0,0x7d);
	SP0A20_write_cmos_sensor(0xa1,0xf2);
	SP0A20_write_cmos_sensor(0xa2,0x10);
	SP0A20_write_cmos_sensor(0xa3,0xdb);
	SP0A20_write_cmos_sensor(0xa4,0xa0);
	SP0A20_write_cmos_sensor(0xa5,0x06);
	SP0A20_write_cmos_sensor(0xa6,0xe6);
	SP0A20_write_cmos_sensor(0xa7,0xba);
	SP0A20_write_cmos_sensor(0xa8,0xe0);
	SP0A20_write_cmos_sensor(0xa9,0x0c);
	SP0A20_write_cmos_sensor(0xaa,0x03);
	SP0A20_write_cmos_sensor(0xab,0x0f);

	SP0A20_write_cmos_sensor(0xac,0x88);
	SP0A20_write_cmos_sensor(0xad,0x0c);
	SP0A20_write_cmos_sensor(0xae,0xe7);
	SP0A20_write_cmos_sensor(0xaf,0xf0);
	SP0A20_write_cmos_sensor(0xb0,0xa9);
	SP0A20_write_cmos_sensor(0xb1,0xe7);
	SP0A20_write_cmos_sensor(0xb2,0xe7);
	SP0A20_write_cmos_sensor(0xb3,0xcd);
	SP0A20_write_cmos_sensor(0xb4,0xca);
	SP0A20_write_cmos_sensor(0xb5,0x30);
	SP0A20_write_cmos_sensor(0xb6,0x33);
	SP0A20_write_cmos_sensor(0xb7,0x0f);

	SP0A20_write_cmos_sensor(0xfd,0x01);
	SP0A20_write_cmos_sensor(0xd3,0x5c);
	SP0A20_write_cmos_sensor(0xd4,0x60);
	SP0A20_write_cmos_sensor(0xd5,0x54);
	SP0A20_write_cmos_sensor(0xd6,0x48);

	SP0A20_write_cmos_sensor(0xd7,0x5c);
	SP0A20_write_cmos_sensor(0xd8,0x60);
	SP0A20_write_cmos_sensor(0xd9,0x54);
	SP0A20_write_cmos_sensor(0xda,0x48);
	...
	SP0A20_write_cmos_sensor(0x10,0x84);
	SP0A20_write_cmos_sensor(0x11,0x84);
	SP0A20_write_cmos_sensor(0x12,0x84);
	SP0A20_write_cmos_sensor(0x13,0x84);
	SP0A20_write_cmos_sensor(0x14,0x96);
	SP0A20_write_cmos_sensor(0x15,0x96);
	SP0A20_write_cmos_sensor(0x16,0x90);
	SP0A20_write_cmos_sensor(0x17,0x8c);
