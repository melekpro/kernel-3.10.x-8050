...
static void init_lcm_registers(void)
{
	...
	dsi_set_cmdq_V3(lcm_txd_initialization_setting_V3, sizeof(lcm_txd_initialization_setting_V3) / sizeof(LCM_setting_table_V3), 1);
...
/* [PLATFORM]-Add-BEGIN by TCTSZ.lizhi.wu, 2015.9.16*/
	...
	{
		LCM_PRINT("otm9605a_txd_dsi_vdo select, gpio1_state = %d, gpio2_state = %d!\n", gpio1_state, gpio2_state);
		return 1;
	}
/* [PLATFORM]-Add-END by TCTSZ.lizhi.wu, 2015.9.16*/
}
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm9605a_txd_dsi_vdo = {
	.name = "otm9605a_txd_dsi_vdo",
