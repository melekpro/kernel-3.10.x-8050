...
static struct LCM_setting_table lcm_vdo_initialization_setting[] = {
	...
	{0xff,2,{0x20,0x02}},
	{0x00,1,{0xA0}},
	{0xC1,1,{0x02}},  // close  timeout
	{0x00,1,{0x92}},
	{0xb3,1,{0x02}}, //CMD 1 mask
	{0x00,1,{0x80}},
	{0xC4,1,{0x01}},//Source output Max. level when non-display and V blanking
	{0x00,1,{0x96}},
	{0xb6,1,{0xb6}},//reload OTP ?
	{0x00,1,{0x00}},
...
// ---------------------------------------------------------------------------
LCM_DRIVER otm1287a_wxga_dsi_vdo_lcm_drv = 
{
    .name			= "otm1287a_wxga_dsi_vdo",
