...
#define MSDC_SDIO_FLAG    (MSDC_EXT_SDIO_IRQ | MSDC_HIGHSPEED | MSDC_UHS1)
  ...
  #endif
#endif
//[BUGFIX]-Mod-BEGIN by SCDTABLET.jinghuang@tcl.com,11/18/2015,871607,769346,814818,861902,885391
//disable sdr104 mode for sd card.
    ...
    struct msdc_hw msdc1_hw = {
        ...
        .data_pins            = 4,
        .data_offset          = 0,
        .flags                = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED  |MSDC_DDR,      
        .dat0rddly            = 0,
        .dat1rddly            = 0,
        .dat2rddly            = 0,
        .dat3rddly            = 0,
