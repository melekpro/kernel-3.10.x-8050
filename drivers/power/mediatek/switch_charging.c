...
/*Battery temperature more than 45 degree or less than 55 degree, try to limit max voltage*/
			if((BMT_status.temperature >= batt_cust_data.max_limit_charge_temperature) && (BMT_status.temperature <= batt_cust_data.max_charge_temperature) )
			{
